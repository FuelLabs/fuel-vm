...
fn check_predicate_allowed() {
    ...
    for byte in 0..u8::MAX {
        ...
        let should_allow = match repr {
            ...
            | RETD | RVRT | SMO | SRW | SRWQ | SWW | SWWQ | TIME | TR | TRO => false,
            ...
            | RESERV0E | RESERV0F | RESERV22 | RESERV23 | RESERV37 | RESERV42 | RESERV43
            | RESERV44 | RESERV45 | RESERV46 | RESERV4D | RESERV4E | RESERV4F | RESERV62
