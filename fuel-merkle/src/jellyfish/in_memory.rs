...
type JellyfishMerkleTree = jellyfish::MerkleTree<NodesTable, Storage>;
...
impl MerkleTree {
    pub fn new() -> Self {
        Self {
            tree: JellyfishMerkleTree::new(Storage::new()),
        }
    }
    ...
    where
        ...
        D: AsRef<[u8]>,
    {
        let tree = JellyfishMerkleTree::from_set(Storage::new(), set)
        ...
        D: AsRef<[u8]>,
    {
        ...
        let tree = jellyfish::MerkleTree::<NodesTable, _>::from_set(EmptyStorage, set)
            .expect("`Storage` can't return error");
        tree.root()
    }
        ...
        D: AsRef<[u8]>,
    {
        ...
        let tree = jellyfish::MerkleTree::<NodesTable, _>::from_set(
