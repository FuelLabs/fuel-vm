...
pub trait Executable: field::Inputs + field::Outputs + field::Witnesses {
    ...
    fn add_verified_read_only_coin_input(
        &mut self,
        utxo_id: UtxoId,
        owner: &PublicKey,
        amount: Word,
        ...
        let input = Input::verified_read_only_coin(
            utxo_id,
            owner,
            amount,
            asset_id,
    ...
    fn add_verified_read_only_data_coin_input(
        &mut self,
        utxo_id: UtxoId,
        owner: &PublicKey,
        amount: Word,
        ...
        let input = Input::verified_read_only_data_coin(
            utxo_id,
            owner,
            amount,
            asset_id,
