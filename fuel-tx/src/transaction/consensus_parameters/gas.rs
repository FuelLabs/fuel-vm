...
impl GasCostsValues {
    ...
    pub fn bsiz(&self) -> Result<DependentCost, GasCostNotDefined> {
        match self {
            ...
            GasCostsValues::V5(v4) => Ok(v4.bsiz),
        }
    }
    ...
    pub fn bldd(&self) -> Result<DependentCost, GasCostNotDefined> {
        match self {
            ...
            GasCostsValues::V5(v4) => Ok(v4.bldd),
        }
    }

    pub fn wdex(&self) -> Result<DependentCost, GasCostNotDefined> {
        match self {
            GasCostsValues::V1(_v1) => Err(GasCostNotDefined),
            GasCostsValues::V2(_v2) => Err(GasCostNotDefined),
            GasCostsValues::V3(_v3) => Err(GasCostNotDefined),
            GasCostsValues::V4(_v4) => Err(GasCostNotDefined),
            GasCostsValues::V5(v5) => Ok(v5.wdex),
        }
    }

    pub fn wqex(&self) -> Result<DependentCost, GasCostNotDefined> {
        match self {
            GasCostsValues::V1(_v1) => Err(GasCostNotDefined),
            GasCostsValues::V2(_v2) => Err(GasCostNotDefined),
            GasCostsValues::V3(_v3) => Err(GasCostNotDefined),
            GasCostsValues::V4(_v4) => Err(GasCostNotDefined),
            GasCostsValues::V5(v5) => Ok(v5.wqex),
        }
    }
...
pub struct GasCostsValuesV5 {
    ...
    pub srwq: DependentCost,
    pub swwq: DependentCost,
    pub wdex: DependentCost,
    pub wqex: DependentCost,
...
impl GasCostsValuesV5 {
    ...
    pub fn free() -> Self {
        Self {
            ...
            srwq: DependentCost::free(),
            swwq: DependentCost::free(),
            wdex: DependentCost::free(),
            wqex: DependentCost::free(),
    ...
    pub fn unit() -> Self {
        Self {
            ...
            srwq: DependentCost::unit(),
            swwq: DependentCost::unit(),
            wdex: DependentCost::unit(),
            wqex: DependentCost::unit(),
