...
#[test]
fn identity() {
    let a = Interpreter::<_, UnreachableEcal, Script>::without_storage();
    let b = Interpreter::<_, UnreachableEcal, Script>::without_storage();
    let diff = a.diff(&b);
...
#[test]
fn reset_vm_state() {
    let a = Interpreter::<_, UnreachableEcal, Script>::with_memory_storage();
    let mut b = Interpreter::<_, UnreachableEcal, Script>::with_memory_storage();
    b.set_gas(1_000_000);
...
fn record_and_invert_storage() {
    ...
    let a = Interpreter::<_, UnreachableEcal, Script>::with_storage(
        Record::new(MemoryStorage::default()),
        interpreter_params.clone(),
    );
    let mut b = Interpreter::<_, UnreachableEcal, Script>::with_storage(
        Record::new(MemoryStorage::default()),
        interpreter_params,
    );
    ...
    let c = Interpreter::<_, UnreachableEcal, Script>::with_memory_storage();
    let mut d = Interpreter::<_, UnreachableEcal, Script>::with_memory_storage();
