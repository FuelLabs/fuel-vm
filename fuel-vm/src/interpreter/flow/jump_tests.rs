...
#[test_case(0, 40, VM_MAX_RAM => Err(RuntimeError::Recoverable(PanicReason::MemoryAccess)); "jump too far forward")]
...
#[test_case(0, 0, 0 => Err(RuntimeError::Recoverable(PanicReason::MemoryAccess)); "jump below zero from zero 0")]
#[test_case(0, 0, 1 => Err(RuntimeError::Recoverable(PanicReason::MemoryAccess)); "jump below zero from zero 1")]
#[test_case(0, 20, 50 => Err(RuntimeError::Recoverable(PanicReason::MemoryAccess)); "jump below zero from nonzero")]
