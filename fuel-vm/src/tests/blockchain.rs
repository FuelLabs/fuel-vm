...
fn smo_instruction_works() {
        ...
        R: Rng,
    {
        ...
        let tx = tx
            ...
            .with_params(*params)
            .finalize_checked(block_height, client.gas_costs(), true);
...
fn block_height_works(#[values(0, 1, 2, 10, 100)] current_height: u32) {
    ...
    let tx = TransactionBuilder::script(script, script_data)
        ...
        .maturity(maturity)
        .with_params(params)
        .finalize_checked(current_height, client.gas_costs(), true);
...
fn coinbase_works() {
    ...
    let tx = TransactionBuilder::script(script, script_data)
        ...
        .maturity(maturity)
        .with_params(params)
        .finalize_checked(10.into(), client.gas_costs(), true);
