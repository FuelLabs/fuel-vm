...
fn metadata() {
    ...
    routine_call_metadata_contract.push(op::call(0x10, REG_ZERO.into(), 0x10, REG_CGAS.into()));
    routine_call_metadata_contract.push(op::ret(REG_ONE.into()));
    ...
    script.push(op::call(0x10, REG_ZERO.into(), 0x10, REG_CGAS.into()));
