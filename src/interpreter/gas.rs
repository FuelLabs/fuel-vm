...
impl<S> Interpreter<S> {
    ...
    pub(crate) fn gas_charge_monad<F>(&mut self, monad: F, arg: Word) -> Result<(), PanicReason>
    where
        F: FnOnce(Word) -> Word,
    {
    ...
    pub(crate) fn gas_charge(&mut self, gas: Word) -> Result<(), PanicReason> {
