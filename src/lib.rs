...
pub mod prelude {
    ...
    pub use crate::interpreter::{
        Call, CallFrame, Context, Contract, ContractData, ContractState, ExecuteError, Interpreter, LogEvent,
        MemoryRange, ProgramState, StateTransition, StateTransitionRef,
    };
